...
/**
 * @extends AbstractType<KonferencjaPrasowa>
 */
class KonferencjaPrasowaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('miejsceWydarzenia', TextType::class, [
                'label' => 'Miejsce wydarzenia',
                'required' => true,
            ])
            ->add('tytulKonferencji', TextType::class, [
                'label' => 'Tytuł konferencji',
                'required' => true,
            ])
            ->add('trescKonferencji', TextareaType::class, [
                'label' => 'Treść/Opis konferencji',
                'required' => false,
                'attr' => ['rows' => 6],
            ])
            ...
            ->add('organizatorWydarzenia', TextType::class, [
                'label' => 'Organizator wydarzenia',
                'required' => false,
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => KonferencjaPrasowa::class,
        ]);
    }
}
